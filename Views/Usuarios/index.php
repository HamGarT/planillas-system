...
<section class="home">
   ...
   <button class="btn btn-outline-primary mb-2" type="button" onclick="frmUsuario()"><i class="fas fa-plus"></i>Agregar</button>
   <div class="container-table table-responsive">
      <table class="table  table-hover display responsive nowrap text-center" id="tblUsuarios" style="width: 100%;">
...
<div class="modal fade " id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="formulario" onsubmit="registrarUser(event)">
